...
(
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // scnn_op_en_o     = 1'b1;
    // scnn_operator_o  = RELU_OP;
    // rega_used_o      = 1'b1;
    // regb_used_o      = 1'b0;
    // regfile_alu_we   = 1'b0;  // <-- FIXED
    // end
    // else if (instr_rdata_i[6:0]   == 7'b1110111 &&   // opcode = 0x77
    //       instr_rdata_i[14:12] == 3'b011      &&   // funct3
    //       instr_rdata_i[31:25] == 7'b0000_000) begin // funct7

    //   scnn_op_en_o     = 1'b1;
    //   scnn_operator_o  = RELU_OP;

    //   rega_used_o      = 1'b1;   // rs1 input operand
    //   regb_used_o      = 1'b0;   // no second source reg

    //   regfile_alu_we   = 1'b1;   // Write back result to rd
    // end
    ////////////// RELU: custom op group 3, func 0
    else if (instr_rdata_i[14:12] == 3'b000 && instr_rdata_i[31:25] == 7'b0000_011) begin
        scnn_op_en_o     = 1'b1;
        scnn_operator_o  = RELU_OP;     // define RELU_OP in your operator enum
        rega_used_o      = 1'b1;        // rs1: ptr
        regb_used_o      = 1'b1;        // rs2: len
        // For RELU we'll need memory read+write; set data_req to tell downstream logic
        // that a data access sequence will happen. The actual read/write FSM lives in the
        // scnn operator implementation (where other ops perform bus transactions).
        data_req         = 1'b1;
        // indicate we will write back to memory (we both read and write)
        data_we_o        = 1'b1;
        // If you have data_type or sign flags, ensure appropriate settings:
        data_type_o      = 2'b10;      // example: 32-bit word accesses (adapt to your scheme)
        alu_op_b_mux_sel_o = OP_B_REGB_OR_FWD;
    end
    ////////////////////////////////////////////////////////
		else
