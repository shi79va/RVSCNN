...
(
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // === RELU custom op: opcode 7'h77, funct3 == 3'b011, funct7 == 7'b0000000 ===
    else if (instr_rdata_i[14:12] == 3'b011 && instr_rdata_i[31:25] == 7'b0000000) begin
        scnn_op_en_o     = 1'b1;
        scnn_operator_o  = RELU_OP;     // RELU_OP already defined in cv32e40p_pkg (you showed 4'b1001)
        rega_used_o      = 1'b1;        // rs1: ptr
        regb_used_o      = 1'b1;        // rs2: len

        // We'll need to read and then write memory, so indicate data access
        data_req         = 1'b1;
        data_we_o        = 1'b1;        // will write back values
        data_type_o      = 2'b10;       // if you use this for 32-bit word accesses (adapt if needed)
        alu_op_b_mux_sel_o = OP_B_REGB_OR_FWD;
    end
